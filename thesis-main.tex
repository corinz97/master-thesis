...
Esistono molte definizioni di \textit{democrazia}, le quali pongono comunque le basi sui principi di elezioni libere in cui i cittadini sono considerati equi, partecipazione
attiva dei cittadini alla vita politica, protezione dei diritti fondamentali e della libertà personale attraverso costituzioni \cite{diamondlarry}\cite{dahl2003democracy}.
...
rappresentative ha preso la maggior diffusione. 

La modernizzazione tecnologica, accelerata di recente con l'avvento della pandemia da Covid-19 che ha evidenziato il notevole problema
logistico della gestione del distanziamento \cite{sotoacosta},  ha aperto un ventaglio di possibilità tali da
permettere un ritorno ad un controllo più diretto da parte della collettività.
La \textit{democrazia digitale} (o \textit{e-democracy}) è l'esercizio di processi decisionali democratici attraverso 
...
in ambito di sicurezza informatica, usabilità, segretezza e manipolazione del voto \cite{hennen}.
...
L'applicazione più comune di queste tecnologie emergenti è legata al mondo della politica\cite{hennen}:
...
di proposte tra i membri di un organizzazione, le quali saranno portate in sede legislativa da un loro rappresentante.
...
da applicare, che per alcuni aspetti rimane implicito\cite{Pianini:2019}. Ciò è dovuto anche al fatto che la partecipazione si concentra 
principalmente alle fasi iniziali e finali del ciclo di votazione \cite{hennen}.
Alcuni autori (\cite{mcgaley}) ribadiscono che è impossibile avere leggitimità in quanto "la natura dei computer è tale che il loro funzionamento interno è segreto.
...
\cite{smartwater} si pone il focus sull'adozione di sistemi di "IdroInformatica". Questo tipo di sistemi permettono di analizzare 
...
In altri Stati, come Canada e Paesi Bassi, la gestione dell'acqua è delegata ad un gestion locale, che promuove la collaborazione tra soggetti pubblici e privati.
