...
%----------------------------------------------------------------------------------------
\chapter{Design}
In questo capitolo viene posto un approfondimento sulla porzione di dominio
impattata dall'introduzione di \ac{dsl}, volto al miglioramento dell'utilizzabilità della libreria \texttt{eleKtion}.
Per ogni funzionalità verrà evidenzata un'apposita descrizione e un diagramma UML
che ne esplichi l'organizzazione. Questi diagrammi sono realizzati con il presupposto di poter adottare l'utilizzo
...
\section{\ac{dsl} per la definizione del gestore di votazioni }
...
Questi due tipo vincolano i seguenti componenti che verranno definiti, pertanto non è possibile adottare diversi metriche di punteggio tra i concorrenti,
...
\vfill
 ...
 \section{\ac{dsl} per la definizione della votazione}
...
\section{\ac{dsl} per la definizione della competizione}
