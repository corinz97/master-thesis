...
sua prestazione nella competizione. Pertanto, è rappresentabile come un criterio di comparazione tra valori, visibile in figura \ref{fig:metrica}.

\vfill
\begin{center} 
\begin{figure}[H]
    \centering
     \includegraphics[width=1.1\linewidth]{figures/random-image.pdf}
...
Si osserva che per la maggior parte delle librerie, più di una versione è attivamente utilizzata in un dato momento. 

Da uno studio empirico \cite{soto2019emergence} è emerso che "circa il 40\% delle librerie ha due o più versioni attivamente utilizzate, 
