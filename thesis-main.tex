...
eventuali pre-votazioni o quorum, ma porrà il focus sulla definizione e gestione dei concorrenti coinvolti,
la tipologia di algoritmo utilizzato per ottenere il risultato finale ed i voti presenti nella fase di votazione.
Al termine della stessa, è disponibile una classifica che riporta informazioni 
circa le specifiche impostate e le caratteristiche dei concorrenti.
    ...
    \begin{itemize}
        ...
        \item{Definizione di una votazione come entry point del processo.} 
        ...
        L'algoritmo potrà essere caratterizzato dalla presenza di opportuni parametri, utili al suo funzionamento.   }
        ...
        Dovrà essere data la possibilita si anonimizzare il votante. Una volta anonimizzato, non sarà possibile risalire alla vera identità.

        
        }
        \item{Le fasi di definizione dovranno essere correlate ad opportuni controlli di congruità. Ad esempio, non dovrà essere
        possibile votare un concorrente che non è presente tra i candidati disponibili.}
